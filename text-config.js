  ...
  kitCategories: [
    {
      ...
      title: 'Tent stuff',
      items: [
        { id: 'kit-tent-tents',       label: '3× tents' },
        { id: 'kit-tent-airmats',     label: '3× airmats' },
        { id: 'kit-tent-sleepbags',   label: '6× sleep bags' },
        { id: 'kit-tent-pillows',     label: '3× pillows' },
        { id: 'kit-tent-duvets',      label: '2× duvets' },
        { id: 'kit-tent-lights',      label: '3× lights' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'kit-gear-towels',      label: 'Towels ×2' },
    ...
    },
    {
      ...
      title: 'Clothes',
      items: [
        { id: 'kit-clothes-rain',         label: 'Rain jackets ×3' },
        { id: 'kit-clothes-puffa',        label: 'Puffa jackets ×3' },
        { id: 'kit-clothes-wellies',      label: 'Wellies' },
        { id: 'kit-clothes-pantssocks',   label: 'Pants & socks' },
        { id: 'kit-clothes-fleece',       label: 'Fleece ×3' },
        { id: 'kit-clothes-tshirts',      label: 'T-shirts' },
        { id: 'kit-clothes-shorts',       label: 'Shorts & leggings' },
        { id: 'kit-clothes-gloves',       label: 'Gloves' },
        { id: 'kit-clothes-caps',         label: 'Caps ×3' },
        { id: 'kit-clothes-woolyhats',    label: 'Woolly hats ×3' },
    ...
    },
    {
      ...
      title: "Kids' gear",
      items: [
        { id: 'kit-kids-books',    label: 'Books ×3' },
        { id: 'kit-kids-teddies',  label: 'Teddies ×2' },
